...
const setColor = function (value, element) {
  if (value === "Zakupy") element.style.backgroundColor = "rgb(74, 211, 80)";
  if (value === "Praca") element.style.backgroundColor = "rgb(255, 243, 0)";
  if (value === "Inne") element.style.backgroundColor = "rgb(15, 203, 227)";
};
...
const addNote = function () {
  ...
  const taskCategoryText = taskCategory.options[taskCategory.value].text;
